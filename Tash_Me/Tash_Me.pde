...
void setup() {
  ...
  PImage friends = loadImage("url.jpg");  // 2. Change this to match the name of your photo. 
...
background(friends);
  ...
  mustache = loadImage("mustache-no-background-hi.png"); // 5. Change this to match your file name.
}
